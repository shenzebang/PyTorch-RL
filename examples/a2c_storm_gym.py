...
from core.a2c_storm import a2c_storm_step
...
def update_params_first(batch):
    ...
    """perform TRPO update"""
    grad_flat, d_theta = a2c_normalize_step(policy_net, value_net, optimizer_policy, optimizer_value, states, actions, returns, advantages, args.l2_reg)
