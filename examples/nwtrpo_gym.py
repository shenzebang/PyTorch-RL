...
from core.nwtrpo import trpo_step
...
parser.add_argument('--newton-weight', type=float, default=1, metavar='G',
                    help='damping (default: 1e-2)')
...
def update_params(batch):
    ...
    """perform TRPO update"""
    trpo_step(policy_net, value_net, states, actions, returns, advantages, args.max_kl, args.damping, args.newton_weight, args.l2_reg)
