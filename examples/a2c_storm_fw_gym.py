...
from core.a2c_storm_fw import a2c_storm_fw_step
...
def update_params(batch, grad_flat, d_theta, i_iter):
    ...
    """perform TRPO update"""
    grad_flat, d_theta = a2c_storm_fw_step(policy_net, value_net, optimizer_policy, optimizer_value, states, actions, returns, advantages, args.l2_reg, grad_flat, d_theta, i_iter, lo)
